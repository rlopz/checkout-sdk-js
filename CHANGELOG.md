...
### [1.61.1-alpha.31ffd09f65170694146f31d6e5024e511299643e](https://github.com/bigcommerce/checkout-sdk-js/compare/v1.8.0...v1.61.1-alpha.31ffd09f65170694146f31d6e5024e511299643e) (2020-04-29)
...
* **payment:** CHECKOUT-4842 Trigger event when "enter" key is pressed in one of hosted payment fields ([8bedca0](https://github.com/bigcommerce/checkout-sdk-js/commit/8bedca0))
...
* **checkout:** INT-2497 Add elavon to supported instruments whitelist ([31ffd09](https://github.com/bigcommerce/checkout-sdk-js/commit/31ffd09))
...
* **shopper:** CHECKOUT-4799 Add Sign-in Email support ([5b99a63](https://github.com/bigcommerce/checkout-sdk-js/commit/5b99a63))
